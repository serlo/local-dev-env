...
echo
docker-compose run hydra clients delete frontend.serlo.org --endpoint http://hydra:4445
...
docker-compose run hydra clients delete rocket.chat --endpoint http://hydra:4445
